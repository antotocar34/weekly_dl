...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/carneca/Documents/Programming/Python/automation/weekly_dl/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('weekly-dl-py3.10' == '') {
...
alias deactivate = source '/home/carneca/Documents/Programming/Python/automation/weekly_dl/.venv/bin/deactivate.nu'
